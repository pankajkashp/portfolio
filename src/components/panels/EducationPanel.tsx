  ...
  return (
    <div className="space-y-12 py-10">
      <div className="space-y-3 mb-16">
        <h3 className="text-lg font-black uppercase tracking-[0.5em] text-[#a855f7]">Academic Records</h3>
        <p className="text-white/40 text-sm font-light">Educational foundations and certifications.</p>
      </div>
